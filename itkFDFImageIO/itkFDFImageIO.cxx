  ...
  while (getline(inFile, line, '\n')) {
    ...
    if(tokens.size() == 4) {
            ...
            if (name == "storage") {
                ...
                if (value == "double" )
                    this->SetPixelType(typeid(double));
                if (value == "float" )
                    this->SetPixelType(typeid(float));
                if (value == "long" )
                    this->SetPixelType(typeid(long));
                if (value == "unsigned long" )
                    this->SetPixelType(typeid(unsigned long));
                if (value == "int" )
                    this->SetPixelType(typeid(int));
                if (value == "unsigned int" )
                    this->SetPixelType(typeid(unsigned int));
                if (value == "short" )
                    this->SetPixelType(typeid(short));
                if (value == "unsigned short" )
                    this->SetPixelType(typeid(unsigned short));
                if (value == "char" )
                    this->SetPixelType(typeid(char));                    
                if (value == "unsigned char" )
                    this->SetPixelType(typeid(unsigned char));
